                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <!-- /.card-body -->
                            <div class="card-footer clearfix">
                                <a href="{{url('admin/new-book')}}" class="btn btn-sm btn-info float-left">New Book</a>
                                <a href="{{url('admin/show-books')}}" class="btn btn-sm btn-secondary float-right">View All
                                    Books</a>
                            </div>
                            <!-- /.card-footer -->
                        </div>
